  ...
  return (
    <section className="py-24 px-6 relative bg-[hsl(28,10%,98%)]">
      <div className="max-w-4xl mx-auto relative">
        <motion.div 
          className="bg-[hsl(28,15%,98%)] rounded-xl p-8 md:p-12 shadow-lg border border-gray-100 relative overflow-hidden"
        ...
        >
          ...
          <div className="text-center relative z-10">
            <motion.h2 
              className="text-3xl md:text-4xl font-bold text-[hsl(28,15%,20%)] mb-4 leading-tight"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.2 }}
              viewport={{ once: true }}
            >
              Ready to share your <span className="text-[hsl(28,50%,50%)]">favorites</span>?
            </motion.h2>

            <motion.p 
              className="text-lg text-[hsl(28,8%,38%)] mb-8 max-w-2xl mx-auto"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              <Link href="/signup" className="inline-block">
                <motion.button
                  className="relative px-8 py-3.5 bg-[hsl(28,70%,50%)] hover:bg-[hsl(28,70%,55%)] text-[hsl(28,20%,15%)] rounded-lg font-medium text-base shadow-sm hover:shadow-md transition-all group overflow-hidden cursor-pointer"
